  ...
  return (
    <nav className="w-full mb-12">
      <ul className='flex items-center justify-center gap-9 text-sm'>
        ...
        <li className={`h-8 ${isBlogPage ? ' text-black dark:text-white border-b-4 border-main-accent dark:border-main-accent-dark' : 'text-secondary-text dark:text-secondary-text-dark'}`}><Link to="/blog/">{t('nav.blog')}</Link></li>
