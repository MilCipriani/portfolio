...
export default function Navbar({ isMenuOpen, setIsMenuOpen }: NavbarProps) {
  const { t } = useLanguage()
  return (
    <nav className="w-screen sticky top-0 left-0 z-50 md:h-32 px-4 md:px-16 lg:px-20 2xl:px-80 4k:px-150 pt-8 pb-4 flex items-center justify-between font-serif">
