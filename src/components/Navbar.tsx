...
export default function Navbar({ isMenuOpen, setIsMenuOpen }: NavbarProps) {
  ...
  return (
    <nav className="px-4 md:px-8 lg:px-16 flex items-center justify-between w-screen bg-white dark:bg-blue navbar-shadow sticky top-0 left-0 z-50 h-24 md:h-32 font-serif">
