  ...
  return (
    <main className='h-full flex flex-col justify-between py-8 xs:py-18'>
      <section className='flex flex-col items-center justify-between h-full max-h-160 lg:w-1/2'>
        ...
        <h2 className='text-center text-xl md:text-2xl lg:text-4xl'>{t('routes.home.h2')}</h2>
        <p className='text-center whitespace-pre-line xxs:text-base'>{t('routes.home.p')}</p>
