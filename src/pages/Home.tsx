  ...
  return (
    <main className='h-full flex flex-col justify-between py-8 xs:py-18'>
      <section className='flex flex-col items-center justify-between h-full max-h-160 lg:w-1/2'>
        ...
        <h2 className='text-center text-sm xxs:text-base md:text-2xl lg:text-4xl'>I'm a software developer who enjoys creating websites that combine clean design with robust functionality.</h2>
