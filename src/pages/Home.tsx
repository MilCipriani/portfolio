...
const { t } = useLanguage()
  ...
  return (
    <main className='h-full flex flex-col justify-between items-center max-w-250 mx-auto'>

      <section className='h-full max-h-200 flex flex-col justify-around items-center my-auto'>
        ...
        <div className='flex flex-col items-center justify-center gap-14 max-w-200'>
